...
*   **Linked Lists:** Extensive hands-on practice with dynamic memory allocation for Singly and Doubly Linked Lists (`Singly_insert_head.c`, `Delete_at_tail.c`, `Doubly_tail.c`).
